...
X = [emplogit(pick("logic_calculation","LH")),... 
     emplogit(pick("logic_calculation","RH")), ...
     emplogit(pick("logic_calculation","bilateral")),...
     emplogit(pick("logic_language","bilateral")), ...
     emplogit(pick("gk_language","bilateral"))];
